...
public class PublicBicycleActivity extends Activity implements OnClickListener, OnMapClickListener {
	...
	private List<BicycleStation> searchList = new ArrayList<BicycleStation>();
	private List<BicycleStation> mBicycleStationList = new ArrayList<BicycleStation>();
	...
	public void onClick(View v) {
		...
		case R.id.publicbicycle_collect:
			it.putExtra("lat", mGeoPoint.getLatitude());
			it.putExtra("lon", mGeoPoint.getLongitude());
		...
		public void handleMessage(Message msg) {
			...
			case FunoConst.RequestSuccess:
				...
				((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(
						PublicBicycleActivity.this.getCurrentFocus().getWindowToken(),
			...
			case FunoConst.Location_Ok:
				...
				break;
			case FunoConst.Location_Fail:
				Toast.makeText(context, "定位失败!", Toast.LENGTH_SHORT).show();
				break;
			case FunoConst.waitTime:
				PublicVar.map_end = false;
				break;
			}
		}
	};
	...
	public void initMapListData(List<BicycleStation> list) {
		...
		bicycleListAdapter = new BicycleListAdapter(context, R.layout.item_bicycle_list, mBicycleStationList, dbManager,
				mGeoPoint, mRoadLineHandler, aMapView, floatToolView, bicycleListView);
...
//
//				}.start();
//				Toast.makeText(context, "地图正在初始化,请稍后", Toast.LENGTH_SHORT).show();
//			} else {
//				finish();
//			}
//		}
